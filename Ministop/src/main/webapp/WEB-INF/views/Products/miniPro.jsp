...
<nav>
  <ul>
	...
	<div id="btn_group">
		...
		<button id="menu_btn2">음료/커피</button>
		<button id="menu_btn2">유제품</button>
		<button id="menu_btn2">과자/간식</button>
		<button id="menu_btn2">라면/가공식품</button>
		<button id="menu_btn3">생활용품</button>
		<br/>
	</div>
	<div id ="btn_group">
