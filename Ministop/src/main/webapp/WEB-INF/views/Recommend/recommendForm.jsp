...
<body>
	<form action="${home }recommend/radiusSearch">
		...
		<div id='recForm'>
			...
			<input type="hidden" id="longitude" name="longitude" /> <input
				type="hidden" id="latitude" name="latitude" /> <input type="submit"
				value="검색" /> <br />
			<div id="map" style="width: 500px; height: 400px; align: center; text-align: center;"></div>
		</div>
	...
	<script>
		...
		for (var i = 0; i < latlist.length; i++) {
			...
			aJson.title = '미니스톱';
			aJson.content = '<div>' + branchlist[i] + '<br/>' + addlist[i]
					+ '<br/></div>';
